...
const (
	BookService_AddBook_FullMethodName    = "/prot.BookService/AddBook"
	BookService_ListBooks_FullMethodName  = "/prot.BookService/ListBooks"
	BookService_GetBook_FullMethodName    = "/prot.BookService/GetBook"
	BookService_RemoveBook_FullMethodName = "/prot.BookService/RemoveBook"
	BookService_UpdateBook_FullMethodName = "/prot.BookService/UpdateBook"
)
...
func (c *bookServiceClient) ListBooks(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*ListBooksResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (UnimplementedBookServiceServer) ListBooks(context.Context, *Empty) (*ListBooksResponse, error) {
...
var BookService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "books/internal/pkg/proto/book.proto",
}
